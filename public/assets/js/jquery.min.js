...
!function (a, b) {
    ...
    r.ajaxSetup({
        ...
        var e, f, g,
            h = b.jsonp !== !1 && (Rb.test(b.url) ? "url" : "string" == typeof b.data && 0 === (b.contentType || "").indexOf("application/x-www-forms-urlencoded") && Rb.test(b.data) && "data");
        ...
        return a.innerHTML = "<forms></forms><forms></forms>", 2 === a.childNodes.length

 ...
 */
final class Version20180924102402 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE customer (id INT AUTO_INCREMENT NOT NULL, type INT DEFAULT NULL, legal_form_id INT DEFAULT NULL, user_id INT DEFAULT NULL, title VARCHAR(255) DEFAULT NULL, street VARCHAR(255) DEFAULT NULL, taxnumber VARCHAR(255) DEFAULT NULL, kvknumber VARCHAR(255) DEFAULT NULL, phone VARCHAR(255) DEFAULT NULL, fax VARCHAR(255) DEFAULT NULL, companyName VARCHAR(255) DEFAULT NULL, oldId VARCHAR(255) DEFAULT NULL, vatNumber VARCHAR(255) DEFAULT NULL, active TINYINT(1) NOT NULL, $hourlyRate NUMERIC(10, 2) DEFAULT NULL, created DATETIME NOT NULL, updated DATETIME NOT NULL, INDEX IDX_81398E098CDE5729 (type), INDEX IDX_81398E0998CD0513 (legal_form_id), INDEX IDX_81398E09A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
